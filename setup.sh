#!/usr/bin/env bash
sudo zypper refresh --no-gpg-checks;
...
sudo zypper ar -cfp 99 'https://ftp.gwdg.de/pub/linux/misc/packman/suse/openSUSE_Tumbleweed/Essentials/' packman-essentials;
sudo zypper refresh --no-gpg-checks;
